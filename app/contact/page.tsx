...
export default function ContactPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    window.open(
      `https://wa.me/13344468194?text=${encodeURIComponent(text)}`,
      '_blank',
      'noopener,noreferrer'
    )
    setSent(true)
          ...
          <div className="contact-grid">
            ...
            <div className="contact-info">
              ...
              <div className="contact-social">
                <a href="https://wa.me/13344468194" className="social-btn social-wa" aria-label="Chat on WhatsApp" target="_blank" rel="noopener noreferrer">
